...
atk_range = 250		// maximum range
show_atk_range = true	// whether to show radius on screen

atk_reload = 80	// time between attacks

shot_num_max = 1	// number of shots before reload

shot_cooldown = 3	// time between shots (if more than one)

shot_spd = 10		// speed of bullet

shot_follows = true	// if shot follows the target or just goes to the location

miss_chance = 15		// the % chance to miss
crit_chance = 5		// the % chance to critically hit

shot_splash = false	// if the bullet does damage in an area

shot_dmg_min = 5	// minimum damage of bullet
shot_dmg_max = 15	// maximum damage of bullet
...
tower_bullet_type = obj_bullet_3// change this to whatever kind of bullet the tower uses
...
atk_reload_timer = 0/// @description Insert description here
// You can write your code in this editor
